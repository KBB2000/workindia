...
const  SearchContainer = ()=>{
    ...
    const GetDataTrending = async ()=>{
        ...
        const {data} = await axios.get(`https://api.themoviedb.org/3/search/${typeValue}?api_key=66a020f88a5c19a54cb50a66ae131b35&page=${pageno}&language=en-US&query=${searchValue}&include_adult=false`);
